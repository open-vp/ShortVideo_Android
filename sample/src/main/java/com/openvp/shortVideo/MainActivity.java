...
import com.openvp.shortVideo.DeviceUtils;
import com.openvp.shortVideo.CameraRec;
import com.openvp.shortVideo.LocalMediaCompress;
import com.openvp.shortVideo.MediaRecorderActivity;
import com.openvp.shortVideo.StringUtils;
import com.openvp.shortVideo.model.AutoVBRMode;
import com.openvp.shortVideo.model.BaseMediaBitrateConfig;
import com.openvp.shortVideo.model.CBRMode;
import com.openvp.shortVideo.model.LocalMediaConfig;
import com.openvp.shortVideo.model.MediaRecorderConfig;
import com.openvp.shortVideo.model.OnlyCompressOverBean;
import com.openvp.shortVideo.model.VBRMode;
...
//      FFMpegUtils.captureThumbnails("/storage/emulated/0/DCIM/openvp/1496455533800/1496455533800.mp4", "/storage/emulated/0/DCIM/openvp/1496455533800/1496455533800.jpg", "1");
    ...
    public static void initSmallVideo() {
        ...
        if (DeviceUtils.isZte()) {
            if (dcim.exists()) {
                CameraRec.setVideoCachePath(dcim + "/openvp/");
            } else {
                CameraRec.setVideoCachePath(dcim.getPath().replace("/sdcard/",
                        "/sdcard-ext/")
                        + "/openvp/");
            }
        } else {
        ...
        // 初始化拍摄
        CameraRec.initialize(false, null);
    }

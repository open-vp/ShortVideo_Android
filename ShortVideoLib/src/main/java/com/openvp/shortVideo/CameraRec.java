...
/**
 * Created by shortVideo on 2017/6/5.
 * https://github.com/openvp
 * openvp@gmail.com
 */

public class CameraRec {
    /** 应用包名 */
    ...
    /** 执行FFMPEG命令保存路径 */
    public final static String FFMPEG_LOG_FILENAME_TEMP = "shortVideo.log";
    ...
    public static void initialize(boolean debug,String logPath) {
        ...
        //AVBaseJni.initJXFFmpeg(debug,logPath);

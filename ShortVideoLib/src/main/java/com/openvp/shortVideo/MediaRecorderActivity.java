...
import com.openvp.shortVideoLib.R;

import com.openvp.shortVideo.CameraRec;
import com.openvp.shortVideo.ProgressView;
import com.openvp.shortVideo.model.MediaObject;
import com.openvp.shortVideo.model.MediaRecorderConfig;
import com.openvp.shortVideo.MediaRecorderBase;
import com.openvp.shortVideo.MediaRecorderNative;
import com.openvp.shortVideo.FileUtils;
import com.openvp.shortVideo.DeviceUtils;

import java.io.File;

//import static com.openvp.shortVideo.R.id.bottom_layout;
...
//        mRecordDelete.setOnClickListener(this);
    ...
    private void initMediaRecorder() {
        ...
        File f = new File(CameraRec.getVideoCachePath());
        if (!FileUtils.checkFile(f)) {
            f.mkdirs();
        }
        String key = String.valueOf(System.currentTimeMillis());
        mMediaObject = mMediaRecorder.setOutputDirectory(key,
                CameraRec.getVideoCachePath() + key);

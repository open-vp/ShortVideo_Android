    ...
    public boolean toggleFlashMode() {
        if (mParameters != null) {
            try {
                ...
                Log.e("shortVideo", "toggleFlashMode", e);
            }
        }
        return false;
    }
    ...
    private boolean setFlashMode(String value) {
        if (mParameters != null && camera != null) {
            try {
                ...
                Log.e("shortVideo", "setFlashMode", e);
            }
        }
        return false;
    }
    ...
    public void startPreview() {
        ...
        try {
            ...
            try {
                ...
                Log.e("shortVideo", "setPreviewDisplay fail " + e.getMessage());
            }
            ...
            Log.e("shortVideo", "startPreview fail :" + e.getMessage());
        }
    }
    ...
    protected void setPreviewCallback() {
        ...
        if (size != null) {
            ...
            try {
                ...
                Log.e("shortVideo", "startPreview...setPreviewCallback...", e);
            }
            Log.e("shortVideo", "startPreview...setPreviewCallbackWithBuffer...width:" + size.width + " height:" + size.height);
        } else {

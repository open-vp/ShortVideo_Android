package com.niurenjob.bullman.ShortVideo.videopublish;
...
import com.niurenjob.bullman.ShortVideo.videopublish.server.PublishSigListener;
import com.niurenjob.bullman.ShortVideo.videopublish.server.ReportVideoInfoListener;
        ...
        mTXugcPublish.setListener(new TXUGCPublishTypeDef.ITXVideoPublishListener() {
            ...
            public void onPublishComplete(TXUGCPublishTypeDef.TXPublishResult result) {
                ...
                if (result.retCode == TXUGCPublishTypeDef.PUBLISH_RESULT_OK) {
                    ...
                    Intent intent = new Intent(TCVideoPublishActivity.this, NewVodPlayerActivity.class);

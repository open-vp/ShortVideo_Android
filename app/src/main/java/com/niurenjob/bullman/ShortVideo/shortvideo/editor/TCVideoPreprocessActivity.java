...
import com.niurenjob.bullman.ShortVideo.editor.common.TCConfirmDialog;
...
//        Log.i(TAG, "onProcessProgress: progress = " + progress);
    ...
    private void startEditActivity() {
        ...
        intent.putExtra(TCVideoSettingActivity.RECORD_CONFIG_BITE_RATE, mCustomBitrate);
        startActivity(intent);
        finish();

        t2 = System.currentTimeMillis();
        Log.d("CostTime", "预处理UI关闭时间：t1:" + String.valueOf(t2 - t1));
    }

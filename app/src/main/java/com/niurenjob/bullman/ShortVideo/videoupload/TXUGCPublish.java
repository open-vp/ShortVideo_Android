package com.niurenjob.bullman.ShortVideo.videoupload;
...
import com.niurenjob.bullman.ShortVideo.videoupload.impl.TVCClient;
import com.niurenjob.bullman.ShortVideo.videoupload.impl.TVCConstants;
import com.niurenjob.bullman.ShortVideo.videoupload.impl.TVCUploadInfo;
import com.niurenjob.bullman.ShortVideo.videoupload.impl.TVCUploadListener;
...
public class TXUGCPublish {
    ...
    public int publishVideo(TXUGCPublishTypeDef.TXPublishParam param) {
        ...
        if (mTVCClient == null) {
            mTVCClient = new TVCClient(mContext, mCustomKey, param.signature, param.enableResume, param.enableHttps, 30);
        } else {

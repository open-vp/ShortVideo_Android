package com.niurenjob.bullman.ShortVideo.editor.transition;
...
import com.niurenjob.bullman.ShortVideo.editor.common.widget.videotimeline.ColorfulProgress;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_transition_up:
                ...
                showUpView();
                break;
            case R.id.btn_transition_zoom_in:
                ...
                showZoomInView();
                break;
            case R.id.btn_transition_zoom_out:
                ...
                showZoomOutView();
                break;
            case R.id.btn_transition_rotate:
                ...
                showRotateView();
                break;
            case R.id.btn_transition_fade_in_out:

...
#include <jni.h>
#include <string>
#include "yuv_encode_h264.h"
#include "pcm_encode_aac.h"
#include "vp_log.h"
#include "media_muxer.h"

using namespace std;

YUVEncodeH264 *h264_encoder;
PCMEncodeAAC *aac_encoder;
...
Java_com_openvp_record_jniinterface_InitEncoder(JNIEnv *env,
                                                                                        jclass type,
    ...
    h264_encoder = new YUVEncodeH264(arguments);
    aac_encoder = new PCMEncodeAAC(arguments);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_openvp_record_jniinterface_encodeFrame2H264(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jbyteArray data_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_openvp_record_jniinterface_encodeFrame2AAC(JNIEnv *env,
                                                                                 jclass type,
                                                                                 jbyteArray data_) {
    jbyte *elements = env->GetByteArrayElements(data_, 0);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_openvp_record_jniinterface_recordEnd(JNIEnv *env,
                                                                           jclass type) {
...
Java_com_openvp_record_jniinterface_nativeRelease(JNIEnv *env,
                                                                               jclass type) {
